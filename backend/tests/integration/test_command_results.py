...
@pytest.mark.asyncio
async def test_upload_command_result_success(
    client: AsyncClient, db_session: AsyncSession, setup_command_test_data
):
    # Setup
...
@pytest.mark.asyncio
async def test_upload_command_result_failure(
    client: AsyncClient, db_session: AsyncSession, setup_command_test_data
):
    endpoint = setup_command_test_data["endpoint"]
...
@pytest.mark.asyncio
async def test_upload_command_result_invalid_status(
    client: AsyncClient, db_session: AsyncSession, setup_command_test_data
):
    endpoint = setup_command_test_data["endpoint"]
