...
class OperatingSystemInventoryService:
    ...
    def __init__(self, session: AsyncSession, repo: OperatingSystemInventoryRepository) -> None:
        self.session = session
        self.repo = repo

    async def get_os_inventory(self, endpoint_id: uuid.UUID) -> Optional[OperatingSystemInventory]:
...
class NetworkAdapterInventoryService:
    ...
    def __init__(self, session: AsyncSession, repo: NetworkAdapterInventoryRepository) -> None:
        self.session = session
        self.repo = repo

    async def get_network_inventory(self, endpoint_id: uuid.UUID) -> list[NetworkAdapterInventory]:
...
class StorageInventoryService:
    ...
    async def get_storage_inventory(self, endpoint_id: uuid.UUID) -> list[PhysicalDiskInventory]:
...
class SoftwareInventoryService:
    ...
    def __init__(self, session: AsyncSession, repo: SoftwareInventoryRepository) -> None:
        self.session = session
        self.repo = repo

    async def get_software_inventory(self, endpoint_id: uuid.UUID) -> list[SoftwareInventory]:
...
class WindowsUpdateInventoryService:
    ...
    def __init__(self, session: AsyncSession, repo: WindowsUpdateInventoryRepository) -> None:
        self.session = session
        self.repo = repo

    async def get_windows_update_inventory(self, endpoint_id: uuid.UUID) -> list[WindowsUpdateInventory]:
...
class WindowsServiceInventoryService:
    ...
    def __init__(self, session: AsyncSession, repo: WindowsServiceInventoryRepository) -> None:
        self.session = session
        self.repo = repo

    async def get_windows_service_inventory(self, endpoint_id: uuid.UUID) -> list[WindowsServiceInventory]:
