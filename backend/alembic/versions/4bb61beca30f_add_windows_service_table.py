...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_windows_service_inventory_current_state"),
        "windows_service_inventory",
        ["current_state"],
        unique=False,
    )
    op.create_index(
        op.f("ix_windows_service_inventory_endpoint_id"),
        "windows_service_inventory",
        ["endpoint_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_windows_service_inventory_id"),
        "windows_service_inventory",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_windows_service_inventory_service_name"),
        "windows_service_inventory",
        ["service_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_windows_service_inventory_start_mode"),
        "windows_service_inventory",
        ["start_mode"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_windows_service_inventory_start_mode"),
        table_name="windows_service_inventory",
    )
    op.drop_index(
        op.f("ix_windows_service_inventory_service_name"),
        table_name="windows_service_inventory",
    ...
    op.drop_index(
        op.f("ix_windows_service_inventory_id"), table_name="windows_service_inventory"
    )
    op.drop_index(
        op.f("ix_windows_service_inventory_endpoint_id"),
        table_name="windows_service_inventory",
