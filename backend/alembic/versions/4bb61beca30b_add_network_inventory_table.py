...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_network_adapter_inventory_endpoint_id"),
        "network_adapter_inventory",
        ["endpoint_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_network_adapter_inventory_interface_guid"),
        "network_adapter_inventory",
        ["interface_guid"],
        unique=False,
    )
    op.create_index(
        op.f("ix_network_adapter_inventory_mac_address"),
        "network_adapter_inventory",
        ["mac_address"],
        unique=False,
    )
    op.create_index(
        op.f("ix_network_adapter_inventory_ipv4"),
        "network_adapter_inventory",
        ["ipv4"],
        unique=False,
    )
    op.create_index(
        op.f("ix_network_adapter_inventory_id"),
        "network_adapter_inventory",
        ["id"],
        unique=False,
    )
...
def downgrade() -> None:
    """Downgrade schema."""
    op.drop_index(
        op.f("ix_network_adapter_inventory_id"), table_name="network_adapter_inventory"
    )
    op.drop_index(
        op.f("ix_network_adapter_inventory_ipv4"),
        table_name="network_adapter_inventory",
    )
    op.drop_index(
        op.f("ix_network_adapter_inventory_mac_address"),
        table_name="network_adapter_inventory",
