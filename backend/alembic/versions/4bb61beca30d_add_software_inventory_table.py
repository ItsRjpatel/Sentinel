...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_software_inventory_application_name"),
        "software_inventory",
        ["application_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_software_inventory_endpoint_id"),
        "software_inventory",
        ["endpoint_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_software_inventory_id"), "software_inventory", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_software_inventory_publisher"),
        "software_inventory",
        ["publisher"],
        unique=False,
    )
    op.create_index(
        op.f("ix_software_inventory_version"),
        "software_inventory",
        ["version"],
        unique=False,
    )
...
def downgrade() -> None:
    """Downgrade schema."""
    op.drop_index(
        op.f("ix_software_inventory_version"), table_name="software_inventory"
    )
    op.drop_index(
        op.f("ix_software_inventory_publisher"), table_name="software_inventory"
    )
    op.drop_index(op.f("ix_software_inventory_id"), table_name="software_inventory")
    op.drop_index(
        op.f("ix_software_inventory_endpoint_id"), table_name="software_inventory"
    )
    op.drop_index(
        op.f("ix_software_inventory_application_name"), table_name="software_inventory"
    )
