...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_physical_disk_inventory_endpoint_id"),
        "physical_disk_inventory",
        ["endpoint_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_physical_disk_inventory_id"),
        "physical_disk_inventory",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_physical_disk_inventory_serial_number"),
        "physical_disk_inventory",
        ["serial_number"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["disk_id"], ["physical_disk_inventory.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["updated_by"], ["users.id"], ondelete="SET NULL"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_logical_volume_inventory_disk_id"),
        "logical_volume_inventory",
        ["disk_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_logical_volume_inventory_drive_letter"),
        "logical_volume_inventory",
        ["drive_letter"],
        unique=False,
    )
    op.create_index(
        op.f("ix_logical_volume_inventory_id"),
        "logical_volume_inventory",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_logical_volume_inventory_volume_guid"),
        "logical_volume_inventory",
        ["volume_guid"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_logical_volume_inventory_volume_guid"),
        table_name="logical_volume_inventory",
    )
    op.drop_index(
        op.f("ix_logical_volume_inventory_id"), table_name="logical_volume_inventory"
    )
    op.drop_index(
        op.f("ix_logical_volume_inventory_drive_letter"),
        table_name="logical_volume_inventory",
    ...
    op.drop_index(
        op.f("ix_physical_disk_inventory_serial_number"),
        table_name="physical_disk_inventory",
    )
    op.drop_index(
        op.f("ix_physical_disk_inventory_id"), table_name="physical_disk_inventory"
    )
    op.drop_index(
        op.f("ix_physical_disk_inventory_endpoint_id"),
        table_name="physical_disk_inventory",
