...
def upgrade() -> None:
    ...
    op.create_index('ix_alert_rules_alert_type', 'alert_rules', ['alert_type'], unique=True)

    # ### Create table endpoint_groups ###
    op.create_table('endpoint_groups',
    ...
    op.create_index('ix_endpoint_groups_name', 'endpoint_groups', ['name'], unique=False)
    op.create_index('ix_endpoint_groups_id', 'endpoint_groups', ['id'], unique=False)
    op.create_index('ix_endpoint_groups_site', 'endpoint_groups', ['site'], unique=False)
    op.create_index('ix_endpoint_groups_department', 'endpoint_groups', ['department'], unique=False)
    ...
    op.create_table('endpoint_alert_states',
    ...
    op.create_index('ix_endpoint_alert_states_alert_type', 'endpoint_alert_states', ['alert_type'], unique=False)
    op.create_index('ix_endpoint_alert_states_endpoint_id', 'endpoint_alert_states', ['endpoint_id'], unique=False)
    op.create_index('ix_endpoint_alert_states_id', 'endpoint_alert_states', ['id'], unique=False)

    # ### Create table endpoint_group_members ###
    op.create_table('endpoint_group_members',
    ...
    op.create_index('ix_endpoint_group_members_group_id', 'endpoint_group_members', ['group_id'], unique=False)
    op.create_index('ix_endpoint_group_members_id', 'endpoint_group_members', ['id'], unique=False)
    op.create_index('ix_endpoint_group_members_endpoint_id', 'endpoint_group_members', ['endpoint_id'], unique=False)
    ...
    op.create_index('ix_job_execution_history_id', 'job_execution_history', ['id'], unique=False)
    op.create_index('ix_job_execution_history_job_id', 'job_execution_history', ['job_id'], unique=False)
    ...
    op.create_index('ix_policy_assignments_target_id', 'policy_assignments', ['target_id'], unique=False)
    op.create_index('ix_policy_assignments_id', 'policy_assignments', ['id'], unique=False)
    ...
    op.create_index('ix_policy_results_endpoint_id', 'policy_results', ['endpoint_id'], unique=False)
    op.create_index('ix_policy_results_policy_id', 'policy_results', ['policy_id'], unique=False)
    ...
    op.add_column('commands', sa.Column('scheduled_at', sa.DateTime(timezone=True), nullable=True))
